...
import yt
####################################PARTS TO EDIT#######################################
ADDON_NAME = 'Reaper'           ### CHANGE THIS NEW NAME OF ADDON
addon_id = 'plugin.video.reaper' ### CHANGE THIS TO NEW FOLDER NAME - plugin.video.***   just change 'testpiece'
Base_Url = 'https://leto.feralhosting.com/grimw01f/tr/'   ###Change this to the location of the folder/url where you will be storing all your files, must end with /
Decode = base64.decodestring
Main_Menu_File_Name = Decode('bWFpbm1lbnUucGhw')
search_filenames = ['serialsearch','moviesearch','demosearch1','demosearch2','demosearch3','demosearch4','demo.php','demo1.php','demo2.php'] ### ADD YOUR PHP FILE NAMES IN HERE TO BE INCLUDED IN SEARCHES
########################################################################################
...
def Main_Menu():
    ...
    for name,url,icon,fanart,desc in Regex:
        if name == 'Favourites':
         	Play(name,url,6,icon,fanart,desc)
        elif 'php' in url:
